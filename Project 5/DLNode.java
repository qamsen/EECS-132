...
public class DLNode<T> {
   ...
   * @param previous  the node that will be before this node in the list, or 
   *                  null if no node is before this one
   ...
   * 
   * @param node  a reference to the node that will be after this node in the 
   *              list
   */
   ...
   * 
   * @param node  a reference to the node that will be before this node in the 
   *              list
   */
