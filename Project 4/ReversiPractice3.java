...
public class ReversiPractice3 {
   ...
   */
  public ReversiPractice3(int x, int y) {
   ...
   */
  public ReversiPractice3(int dimension) {
   ...
   */
  private JFrame getSkipTurnFrame() {
   ...
   */
  private JFrame getEndOfGameFrame() {
    return endOfGame;
  }
  
  private JButton[][] getButtonGrid() {
    return buttonGrid;
  }
  ...
  /**
   * Determines if a turn needs to be skipped
   * 
  ...
  private void skipTurnDialogue() {
    ...
    if(getWhiteTurn())
      turnSkippedDialogue.setText("White has no moves, it's now black's turn");
    else
      turnSkippedDialogue.setText("White has no moves, it's now black's turn");
  }
  ...
  public static void main(String[] args) {
    ...
    /* With two input, launch an input1 by input2 Reversi*/
      ...
      try {
        ...
        new ReversiPractice3(input1, input2);
      }
      /* Error message if it's not an integer*/
      catch (NumberFormatException e) {
        errorFrame.setSize(300, 110);
      ...
      new ReversiPractice3(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
    }
